...
public class BannerViewPager extends ViewPager {
    ...
    public BannerViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        mScroller = new BannerScroller(context, new BounceInterpolator());
        setScroller();
    }
    ...
    public void setAdapter(BannerBaseAdapter adapter) {
        ...
        int disPosition = Integer.MAX_VALUE / 2 % mAdapter.getCount();
        setCurrentItem(Integer.MAX_VALUE / 2 - disPosition);
    }
    ...
    private PagerAdapter mPageAdapter = new PagerAdapter() {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View itemView = mAdapter.getView(container, index);
